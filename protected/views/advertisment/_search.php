...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_advertisment'); ?>
		<?php echo $form->textField($model,'id_advertisment'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'validity_time'); ?>
		<?php echo $form->textField($model,'validity_time'); ?>
	</div>
