...
class RealEstateController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RealEstate']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_real_estate));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('RealEstate');
	 ...
	 * @param RealEstate $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='real-estate-form')
		{
